...
export default function About() {
    ...
    // we'll make mystyle a state variable
    const [myStyle,setMyStyle]= useState({
        color:"white",
        backgroundColor:"black"
    })
    const [toggleBtnText,setBtn]=useState("Enable Dark Mode");
  ...
  return (
    ...
    <div classNameName="container"  style={myStyle}>
        ...
        <button classNameName="btn btn-primary" onClick={toggleStyle} style={myStyle} >{toggleBtnText}</button>
    </div>
  )
}
